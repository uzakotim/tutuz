    ...
    <div className="relative min-h-screen overflow-hidden bg-grid">
      ...
      <main className="relative mx-auto flex max-w-4xl flex-col items-center px-6 py-24 text-center">
        ...
        <div className="animate-slide-up flex flex-col items-center gap-5">
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-indigo-200/80 bg-white/80 px-4 py-1.5 text-sm font-medium text-indigo-700 shadow-sm shadow-indigo-100 backdrop-blur">
        ...
        <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row animate-slide-up" style={{ animationDelay: "160ms" }}>
          ...
          <Link
            href="/auth"
            id="cta-sign-in"
            className="rounded-2xl border border-slate-200 bg-white/80 px-10 py-4 text-[15px] font-semibold text-slate-700 backdrop-blur transition duration-200 hover:border-indigo-300 hover:bg-white hover:text-indigo-700 hover:-translate-y-0.5 focus-ring"
          >
            Sign in
          </Link>
        </div>
